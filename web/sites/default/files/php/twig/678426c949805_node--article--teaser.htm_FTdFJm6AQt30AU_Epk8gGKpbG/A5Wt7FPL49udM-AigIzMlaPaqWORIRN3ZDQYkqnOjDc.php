...
class __TwigTemplate_f40720ace41aea4a75f85183079ebbc9 extends Template
{
...
\t\t\t<a href=\"";
            ...
            yield "</a> ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["node"] ?? null), "date", [], "any", false, false, true, 86), "html", null, true);
            yield "
\t\t</h2>
\t";
        }
...
\t\t<p class=\"node-created\">";
        // line 92
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, ($context["node"] ?? null), "createdtime", [], "any", false, false, true, 92), "F j, Y"), "html", null, true);
        yield "</p>
\t\t";
        // line 93
