...
class __TwigTemplate_dc072e489873d2d00e50bf8ef3f199b2 extends Template
{
        ...
        foreach ($context['_seq'] as $context["key"] => $context["row"]) {
          ...
          ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, $context["row"], "title", [], "any", false, false, true, 25)) {
                ...
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["row"], "title", [], "any", false, false, true, 26), "html", null, true);
                yield "</h4>
          ";
            }
            // line 28
