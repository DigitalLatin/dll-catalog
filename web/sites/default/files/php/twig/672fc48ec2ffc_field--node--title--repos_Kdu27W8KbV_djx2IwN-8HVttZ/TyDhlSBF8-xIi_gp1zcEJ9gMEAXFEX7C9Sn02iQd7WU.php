...
class __TwigTemplate_36fe0489ad3c70712f0598e0d7c108f4 extends Template
{
...
($context["label_display"] ?? null), 36, $this->source))];
            ...
            yield "\t";
            // line 40
            $context["id"] = ("item-record-" . \Drupal\Component\Utility\Html::getId($this->sandbox->ensureToStringAllowed(($context["field_name"] ?? null), 40, $this->source)));
            // line 42
            yield "\t<span";
